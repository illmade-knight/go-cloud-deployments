...
require (
	...
	github.com/illmade-knight/go-cloud-manager v0.2.12-beta
	github.com/illmade-knight/go-dataflow v0.2.1-beta
	github.com/illmade-knight/go-dataflow-services v0.2.1-beta
